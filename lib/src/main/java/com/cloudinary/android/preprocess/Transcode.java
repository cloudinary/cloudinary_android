...
public class Transcode implements Preprocess<Uri> {
    ...
    public Uri execute(Context context, Uri resource) throws PreprocessException {
        ...
        TransformationListener transformationListener = new VideoTranformationListener();
    ...
    private class VideoTranformationListener implements TransformationListener {
        @Override
